...
export const projects = [
    ...
    text: "AI-ready e-commerce demo: витрина товаров, фильтры, корзина, AI-подбор и подготовленное сообщение для менеджера. Лёгкий быстрый сайт на Vite/React с отдельным favicon и mobile-first адаптивом.",
    description: "AI-ready e-commerce demo: витрина товаров, фильтры, корзина, AI-подбор и подготовленное сообщение для менеджера. Лёгкий быстрый сайт на Vite/React с отдельным favicon и mobile-first адаптивом.",
    name: "StorePilot AI",
